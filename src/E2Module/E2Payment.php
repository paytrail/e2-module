...
class E2Payment
{
    public const DEFAULT_PAYMENT_URL = 'https://payment.paytrail.com/e2';

    private const DEFAULT_ALGORITHM = 1;
    private const DEFAULT_LOCALE = 'fi_FI';

    public const PARAMS_IN = 'MERCHANT_ID,URL_SUCCESS,URL_CANCEL,ORDER_NUMBER,PARAMS_IN,PARAMS_OUT,MSG_UI_MERCHANT_PANEL,URL_NOTIFY,LOCALE,CURRENCY,PAYMENT_METHODS,ALG';
    public const PARAMS_OUT = 'ORDER_NUMBER,PAYMENT_ID,AMOUNT,CURRENCY,PAYMENT_METHOD,TIMESTAMP,STATUS';
